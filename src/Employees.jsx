                        ...
                        {employees.map(employee => (
                            <div key={employee.id} id={employee.id} className='card m-2' style={{ cursor: 'pointer' }}>
                                <div className='card'>
                                    ...
                                    {employee.gender === 'female' ? <img src={femaleProfile} className='card-image-top' alt={employee.gender} />
                                        : <img src={maleProfile} className='card-image-top' alt={employee.gender} />
                                    }
